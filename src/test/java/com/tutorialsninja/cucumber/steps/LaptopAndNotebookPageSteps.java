...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new com.tutorialsninja.pages.CheckoutPage().enterFirstName("Manisha");
        new com.tutorialsninja.pages.CheckoutPage().enterLastName("Mavani");
        new com.tutorialsninja.pages.CheckoutPage().enterEmailId("Manisha");
